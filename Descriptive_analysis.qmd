...
##### Relationship between victim's descent and crime type
```{r}
data %>%
...
Here we identified among all the crime types, Burglary and Assault have been reported more. so we carried out separate exploration for each.

This set of Bar plots give an idea regarding what type of crimes frequently happened in a particular area. Since Burglary and Assault has a significant occurrence, we are reporting them separately.
