...
In this part we explored the question that whether for committing a particular type of crime commit-er has preference over the weapons based on the victim's sex. We explored for the weapons used more than 10 times for committing a particular crime in the data-set.
